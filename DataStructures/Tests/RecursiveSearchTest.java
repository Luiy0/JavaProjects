/*
 * RecursiveSearchingTest.java
 * This is a source file with a class to test the recursive searching
 * methods.
 */
...
import Algorithms.RecursiveSearch;
...
public class RecursiveSearchTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Using linear search, index=" + 
				RecursiveSearch.linearSearch(unsorted, key));
		System.out.println();
		...
		System.out.println("Using linear search, index=" + 
				RecursiveSearch.linearSearch(sorted, key));
		System.out.println("Using binary search, index=" + 
				RecursiveSearch.binarySearch(sorted, key));
	}
